...
class _ContactsPageState extends State<ContactsPage> {
  ...
  final List<Map<String, String>> _allContacts = [
    {'name': 'Jason Johnson', 'phone': '+1 888 224 556 2345', 'initials': 'JJ', 'type': 'Clients'},
    {'name': 'Alice Anderson', 'phone': '+1 555 123 4567', 'initials': 'AA', 'type': 'Agents'},
    {'name': 'Brian Brown', 'phone': '+1 444 987 6543', 'initials': 'BB', 'type': 'Clients'},
    {'name': 'Catherine Clark', 'phone': '+1 333 222 9999', 'initials': 'CC', 'type': 'Agencies'},
    {'name': 'David Doe', 'phone': '+1 222 555 7890', 'initials': 'DD', 'type': 'Clients'},
    {'name': 'Emily Evans', 'phone': '+1 111 444 1234', 'initials': 'EE', 'type': 'Agents'},
    {'name': 'Frank Foster', 'phone': '+1 777 888 3456', 'initials': 'FF', 'type': 'Agencies'},
    {'name': 'Grace Green', 'phone': '+1 666 123 7890', 'initials': 'GG', 'type': 'Clients'},
     {'name': 'Henry Hill', 'phone': '+1 999 888 7777', 'initials': 'HH', 'type': 'Agents'},
    {'name': 'Ivy Irvin', 'phone': '+1 000 111 2222', 'initials': 'II', 'type': 'Agencies'},
  ];
                  ...
                  child: Column(
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          _buildFilterCard('Clients', Icons.person_outline),
                          _buildFilterCard('Agents', Icons.badge_outlined),
